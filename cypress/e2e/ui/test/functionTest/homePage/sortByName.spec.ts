...
describe("Sort by Name of Tools on Filter Panel", () => {
  ...
  it("should sort tools alphabetically in descending order", () => {
    sortAndVerify(sortedProducts, filterPanel.strings.SORT_BY_NAME_DESC_OPTION, DESC_SORT_ORDER, numOfTools);
  });

  it("should sort tools alphabetically in ascending order", () => {
    sortAndVerify(sortedProducts, filterPanel.strings.SORT_BY_NAME_ASC_OPTION, ASC_SORT_ORDER, numOfTools);
  });
});
